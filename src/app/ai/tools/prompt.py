...
This tool will fetch a list of commits for a specific repository. **VERY IMPORTANT**: You must specify the repository name as a string input parameter."""

GET_REPO_INFO_PROMPT = """
This tool will fetch information about a specific repository. **VERY IMPORTANT**: You must specify the repository name as a string input parameter."""

GET_REPOS_INFO_PROMPT = """
This tool will fetch information about all repositories for the authenticated user. No input parameters are required."""